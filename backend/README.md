...
## Project Structure
    ...
    ├── qr_code_scanner_32280  # Django project configurations
...
1. Clone this repo and `cd qr_code_scanner_32280`
...
2. Clone this repo and `cd qr_code_scanner_32280`
